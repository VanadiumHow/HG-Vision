...
namespace ProgramGerneral
{
    ...
    public partial class FrmSplashScreen : Form
    {
        ...
        private volatile string m_sStatus;
        ...
        static public void ShowSplashScreen(string programName)
        {
        ...
        private void UpdateTimer_Tick(object sender, System.EventArgs e)
        {
            ...
            if (m_bFirstLaunch == false && m_dblLastCompletionFraction < m_dblCompletionFraction)
            {
                ...
                if (progressBarEX != null && !progressBarEX.IsDisposed)
                {
                    int step = (int)(m_dblLastCompletionFraction * 100);
                    if (progressBarEX.Value + step - progressBarEX.Value > 100)
                    {
                        progressBarEX.Value = 100;
                    }
                    else
                    {
                        progressBarEX.Value = progressBarEX.Value + step - progressBarEX.Value;
                    }
