        ...
        private void uiSymbolButton1_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("确定要保存图像参数？", "提示", MessageBoxButtons.OKCancel) == DialogResult.OK)
            {
                try
                {
                    ...
                    if (!Project.Instance().VisionManagerInstance.ImageManagerInstance.ImageParams[index].RawImageSaveOpportunity.Equals((ImageStoreHelper.SAVEOPPORTUNITY)radioChanceRawIsSave.SelectedIndex))
                    {
                        ...
                        Project.Instance().VisionManagerInstance.ImageManagerInstance.ImageParams[index].RawImageSaveOpportunity = (ImageStoreHelper.SAVEOPPORTUNITY)radioChanceRawIsSave.SelectedIndex;
                    ...
                    if (!Project.Instance().VisionManagerInstance.ImageManagerInstance.ImageParams[index].ResultImageSaveOpportunity.Equals((ImageStoreHelper.SAVEOPPORTUNITY)radioChanceResultIsSave.SelectedIndex))
                    {
                        ...
                        Project.Instance().VisionManagerInstance.ImageManagerInstance.ImageParams[index].ResultImageSaveOpportunity = (ImageStoreHelper.SAVEOPPORTUNITY)radioChanceResultIsSave.SelectedIndex;
